...
\begin{mysection}{Experience}[Math \sbull Physics \sbull Programming \sbull Data \sbull Education]
    ...
    \begin{headedsection}{Software Engineer \ --- \ \ 2017--2018}{Emerald Cloud Labs}
        ...
        \item Generated executive buy in to get things done
    \end{headedsection}
...
\begin{headedsection}
    ...
    \begin{headedsection}
          {Lab Assistant for Dean of Engineering, Arthur Ramirez}
...
\begin{mysection}{Projects}[Python \sbull C \sbull Unix \sbull SQL \sbull Git]
    ...
    \begin{headedsection}{Completed Google \href{https://news.ycombinator.com/item?id=8588080}{foo.bar}}
        ...
        \item Allegedly equivalent to Google technical interview
...
%\directlua{
%    local handle = assert(io.popen('pass phone', 'r'))
%    local phone = handle:read('*a')
%    handle:close()
%    tex.print(phone)
%}
\end{center}
