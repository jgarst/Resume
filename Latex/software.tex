...
\begin{mysection}{Projects}[
    ...
    \begin{headedsection}{Python Educator}{}
        ...
        \item Students have a broad set of backgrounds.
...
\begin{mysection}{Skills}
    ...
    \makebox[0pt][l]{\large\bfseries Software Fundamentals:}\phantom{\large\bfseries Software Fundamentals: \quad}OOP, REST APIs, unix/linux, database design, system design
    \end{addmargin}

    \begin{addmargin}[0.5em]{0em}
        \makebox[0pt][l]{\large\bfseries Fluent With:}\phantom{\large\bfseries Software Fundamentals: \quad}Python, SQL, Flask, pytest, pandas, NumPy, SciPy, git, bash, statistics
    ...
    \makebox[0pt][l]{\large\bfseries Familiar With:}\phantom{\large\bfseries Software Fundamentals: \quad}C, Java, Ruby, Airflow, Heroku, SQLAlchemy, Rails
    \end{addmargin}
