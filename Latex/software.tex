...
\begin{mysection}{Experience}[
  ...
  \begin{addmargin}[0.5em]{0em}
    ...
    \begin{adjustwidth}{1ex}{0ex}
      ...
      \item Built most of the ingestion for the main analytics warehouse.
      \\    Stable costs despite Terrabytes of extra source data per month.
      \\    Includes batch updates, streaming change data capture, and polling
            unreliable external APIs.
      \\    Packaged pipelines in terraform modules, managed organic adoption
            by multiple other teams.

      \item Adapted existing warehousing techniques to transform an order of
            magnitude more data.
