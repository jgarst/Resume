  ...
  \begin{addmargin}[0.5em]{0em}
    ...
    \begin{adjustwidth}{1ex}{0ex}
      ...
      \item Built most of the infrastructure for ingestion into our main
            analytics warehouse.
      \\    Including batch updates, streaming change data capture, and polling
            unreliable external APIs.
      \\    Managed organic adoption of my ingestion terraform modules by 
      ...
      \\    Worked with the team on our complexity budget and tradeoffs.
