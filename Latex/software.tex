...
% working steadily towards longer term goals.
  ...
  \begin{addmargin}[0.5em]{0em}
    ...
    Terraform - Kubernetes - AWS - Linux - Python - Shell Scripting - PostgreSQL - Redis
    ...
    \\    Owned Terraform onboarding, automated deployments and version upgrades, RBAC by default.
    ...
    \item Transitioned pure operations DBA team to reliability engineering responsiblities.
    \\    Mentored collegues on modern software tools and Infrastructure as Code.
    \item Carries a pager for the site.  Contributes to on-call as an intentional team practice.
...
% costs.
  ...
  \begin{addmargin}[0.5em]{0em}
    ...
    \begin{adjustwidth}{1ex}{0ex}
      Python - SQL - AWS - Terraform - Snowflake - Airflow
